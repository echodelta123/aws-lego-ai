...
| - | ---------------------------- | -------------------------------- | -------------------------------------------- | -------------------------------------- |
| 1 | Graph AI Product Recommender | `01-lego-recommendation-engine/` | Bedrock, SageMaker, Kinesis, S3, DynamoDB    | LLM + graph ML recommendation system   |
| 2 | Customer Support Agent       | `02-customer-support-agent/`     | Bedrock Agents, OpenSearch, Lambda, SQS      | Conversational support with escalation |
